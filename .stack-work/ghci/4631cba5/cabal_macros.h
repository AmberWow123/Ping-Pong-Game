...
/* package ping-pong-0.1.0.0 */
#ifndef VERSION_ping_pong
#define VERSION_ping_pong "0.1.0.0"
#endif /* VERSION_ping_pong */
#ifndef MIN_VERSION_ping_pong
#define MIN_VERSION_ping_pong(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ping_pong */
...
#define CURRENT_COMPONENT_ID "ping-pong-0.1.0.0-JkcPUfkJxzG9cV7cEylpiy-brick-ping-pong"
